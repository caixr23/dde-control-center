    ...
    , m_speedTime(DEFAULT_SPEED_TIME)
{
    ...
    QScrollBar *bar = m_contentArea->verticalScrollBar();
    bar->setSingleStep(1);
    m_contentArea->setVerticalScrollBarPolicy(Qt::ScrollBarSlideAnimationOn);
#endif
...
void ContentWidget::ensureWidgetVisible(QWidget *childWidget, int xmargin, int ymargin)
{
    m_contentArea->ensureWidgetVisible(childWidget);
}
