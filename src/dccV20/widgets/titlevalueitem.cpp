    ...
    , m_pActivatorBtn(new QPushButton)
{
    ...
    m_pActivatorBtn->setMinimumWidth(64);
    DFontSizeManager::instance()->bind(m_pActivatorBtn, DFontSizeManager::T7, QFont::Normal);
...
QWidget *TitleAuthorizedItem::getActivatorBtn()
{
    return m_pActivatorBtn;
}
